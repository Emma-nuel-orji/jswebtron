        ...
        function e(e) {
            ...
            function d() {
                var e = t.find(".owl-item.active").find(".wd-slide").attr("id"),
                    e = t.find('[id="' + e + '"]');
                t.find(".owl-item.pseudo-active").removeClass("pseudo-active"), e.each(function() {
                    var e = o(this);
            ...
            }, e.data("sliding_speed") && (a.smartSpeed = e.data("sliding_speed"), a.dragEndSpeed = e.data("sliding_speed")), e.data("animation") && (a.animateOut = e.data("animation"), a.mouseDrag = !0), e.data("content_animation") && (d(), a.onTranslated = function() {
                d()
            }), woodmartThemeModule.$window.on("vc_js", function() {
                t.trigger("refresh.owl.carousel")
            }), t.find("link").appendTo("head"), t.owlCarousel(a), "yes" === e.data("autoheight") && t.imagesLoaded(function() {
                t.trigger("refresh.owl.carousel")
            }))
        }
