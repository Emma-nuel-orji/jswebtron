(() => {
                    ...
                    var x = function() {
                            ...
                            return y.parse = function(t) {
                                ...
                                var n = this,
                                    ...
                                    u = $.p(t),
                                    f = function(t, e) {
                                        var r = $.w(n.$u ? Date.UTC(n.$y, e, t) : new Date(n.$y, e, t), n);
                                        return i ? r : r.endOf(s)
                                    },
                                    m = function(t, e) {
                                        return $.w(n.toDate()[t].apply(n.toDate("s"), (i ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), n)
                                    },
                                    h = this.$W,
                                    g = this.$M,
                                    y = this.$D,
                                ...
                                var m, h = $.p(p),
                                    ...
                                    _ = this - g,
                                    b = $.m(this, g);
                                return b = (m = {}, m[d] = b / 12, m[l] = b, m[u] = b / 3, m[c] = (_ - y) / 6048e5, m[s] = (_ - y) / 864e5, m[a] = _ / n, m[o] = _ / e, m[r] = _ / t, m)[h] || _, f ? b : $.a(b)
                ...
                t.exports = function() {
                    ...
                    function X() {
                        ...
                        const {
                            ...
                            DOMParser: U,
                            trustedTypes: P
                        } = e, F = w.prototype, W = x(F, "cloneNode"), j = x(F, "nextSibling"), V = x(F, "childNodes"), J = x(F, "parentNode");
                        ...
                        let Rt = !0,
                            ...
                            zt = {},
                            Ht = null;
                        const Ut = A({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
                        let Pt = null;
                        const Ft = A({}, ["audio", "video", "img", "source", "image", "track"]);
                        let Yt = null;
                        const Wt = A({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
                        ...
                        const ne = a.createElement("form"),
                            ...
                            re = function(t) {
                                if (!ee || ee !== t) {
                                    ...
                                    } else void 0 === K && (K = Z(P, r)), null !== K && "string" == typeof Q && (Q = K.createHTML(""));
                                    o && o(t), ee = t
                                }
                            },
                        ...
                        const ue = function(t) {
                            ...
                            fe = function(t) {
                                ...
                                return t && n && r.insertBefore(a.createTextNode(n), r.childNodes[0] || null), qt === Gt ? it.call(e, Et ? "html" : "body")[0] : Et ? e.documentElement : r
                            },
                            me = function(t) {
                                ...
                                if (!mt[i] || bt[i]) {
                                    ...
                                    if (Rt && !Ht[i]) {
                                        const e = J(t) || t.parentNode,
                                            n = V(t) || t.childNodes;
                                        if (n && e)
                                            for (let i = n.length - 1; i >= 0; --i) e.insertBefore(W(n[i], !0), j(t))
                                    }
                                    return de(t), !0
                                }
                                return t instanceof w && !ue(t) ? (de(t), !0) : "noscript" !== i && "noembed" !== i && "noframes" !== i || !b(/<\/no(script|embed|frames)/i, t.innerHTML) ? (xt && 3 === t.nodeType && (e = t.textContent, e = g(e, at, " "), e = g(e, st, " "), e = g(e, ct, " "), t.textContent !== e && (p(n.removed, {
                                    element: t.cloneNode()
                            ...
                            we = function(t) {
                                ...
                                for (o = a.length; o--;) {
                                    ...
                                    xt && (i = g(i, at, " "), i = g(i, st, " "), i = g(i, ct, " "));
                                    const u = te(t.nodeName);
                                    if (be(u, r, i)) {
                                        if (!Ot || "id" !== r && "name" !== r || (pe(c, t), i = Lt + i), K && "object" == typeof P && "function" == typeof P.getAttributeType)
                                            if (l);
                                            else switch (P.getAttributeType(u, r)) {
                                                case "TrustedHTML":
                                                    i = K.createHTML(i);
                                                    break;
                        ...
                        return n.sanitize = function(t) {
                            ...
                            if (St || re(c), n.removed = [], "string" == typeof t && (It = !1), It) {
                                if (t.nodeName) {
                                ...
                                if (!Dt && !xt && !Et && -1 === t.indexOf("<")) return K && Nt ? K.createHTML(t) : t;
                            ...
                            return Et && mt["!doctype"] && e.ownerDocument && e.ownerDocument.doctype && e.ownerDocument.doctype.name && b(B, e.ownerDocument.doctype.name) && (d = "<!DOCTYPE " + e.ownerDocument.doctype.name + ">\n" + d), xt && (d = g(d, at, " "), d = g(d, st, " "), d = g(d, ct, " ")), K && Nt ? K.createHTML(d) : d
    ...
    n.n = t => {
        ...
        const A = function(t, e) {
            let n = "",
                i = t.predefinedText;
            if (i = i.replace(/\[njwa_page_title\]/gi, encodeURIComponent(document.title)), i = i.replace(/\[njwa_page_url\]/gi, window.location.href), i = i.replaceAll(/\n/gi, "%0A"), -1 !== t.number.indexOf("chat.whatsapp.com")) n += t.number;
            else {
        ...
        window.njtWhatsApp = {
            createButton: function(t, e) {
                ...
                l.setAttribute("class", "nta-wa-gdpr"), l.appendChild((() => {
                    ...
                    e.appendChild(t), e.appendChild((() => {
                        ...
                        return t.innerHTML = b().sanitize(n.options.styles.gdprContent.replaceAll(/\r\n\r\n/gm, "<br/>")), t
                    })());
            ...
            createWidget: function(t, e) {
                ...
                s.setAttribute("class", "wa__popup_heading"), s.style.background = i.backgroundColor, s.append((() => {
                    const t = document.createElement("div");
                    return t.className = "wa__popup_title", t.innerHTML = b().sanitize(i.title), t.style.color = i.textColor, t
                })()), s.append((() => {
                    const t = document.createElement("div");
                    return t.className = "wa__popup_intro", t.innerHTML = b().sanitize(i.description.replaceAll(/\r\n\r\n/gm, "<br/>")), t.style = "#fff" == i.textColor || "#ffffff" == i.textColor ? "color: #D9EBC6" : "color: " + i.textColor + "; opacity: 0.8", t
                })());
                const c = document.createElement("div");
                ...
                l.className = "wa__popup_content wa__popup_content_left", l.appendChild((() => {
                    const t = document.createElement("div");
                    return t.className = "wa__popup_notice", t.innerHTML = b().sanitize(i.responseText.replaceAll(/\r\n\r\n/gm, "<br/>")), t
                    ...
                    return t.className = "wa__popup_content_list", t.onclick = function() {
                        ...
                        let r = A(t, n);
                        const o = document.createElement("div");
                        o.className = "wa__popup_avatar" + (t.avatar ? "" : " nta-default-avt"), o.appendChild((() => {
                            if (t.avatar) {
                        ...
                        a.className = "wa__popup_content_item" + (n.gdprStatus ? " pointer-disable" : ""), a.appendChild((() => {
                            ...
                            return e.setAttribute("target", "ON" == n.urlSettings.openInNewTab ? "_blank" : "_self"), e.setAttribute("href", r), e.setAttribute("rel", "nofollow noopener noreferrer"), e.className = "wa__stt" + ("online" === i ? " wa__stt_online" : " wa__stt_offline"), e.onclick = function() {
                                y(this, {
                                    enabledFacebook: n.options.analytics.enabledFacebook,
                                    enabledGoogle: n.options.analytics.enabledGoogle,
                                    enabledGoogleGA4: n.options.analytics.enabledGoogleGA4
                                ...
                                let n = "";
                                return n += `<div class="wa__member_name">${t.accountName}</div>`, n += `<div class="wa__member_duty">${t.title}</div>`, n += "online" != i ? `<div class="wa__member_status">${i}</div>` : "", e.innerHTML = b().sanitize(n), e
                            })()), e
                        })()), e.appendChild(a)
                    })), t
                })());
                var u = '<a target="_blank" href="https://ninjateam.org/whatsapp-chat-wordpress/"><svg class="wa__popup_icon-ninja" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve"><g> <path class="st0" fill="#a9a9a9" d="M286.3,67C238,67,194,85.3,160.8,115.2l0-0.1l-13.2-27.8L84.9,49.2l8.5,66.4l27.1,21.1l-31.8-19.9l-60,8.9   l40.2,46.1l48.9,0.3C105.6,197,98.7,225,98.7,254.6c0,103.6,84,187.6,187.6,187.6s187.6-84,187.6-187.6S389.9,67,286.3,67z    M285.8,346.3c-111,0-171.9-63.2-171.9-92.5s62.2-91.5,171.9-91.5c109.5,0,172.8,62.1,172.8,91.5   C458.6,283.2,398.4,346.3,285.8,346.3z"/> <ellipse fill="#a9a9a9" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -77.6656 328.6796)" class="st1" cx="357.9" cy="258.1" rx="20.6" ry="20.6"/> <ellipse fill="#a9a9a9" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -119.8129 226.9269)" class="st1" cx="214" cy="258.1" rx="20.6" ry="20.6"/></g></svg></a>',
